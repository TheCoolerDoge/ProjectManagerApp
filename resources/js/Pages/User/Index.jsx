                                ...
                                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 border-b-2 border-gray-500">
                                    <tr className="text-nowrap">
                                        ...
                                        <th className="px-3 py-3">
                                            <TextInput defaultValue={queryParams.name} className={"w-full"} placeholder="User Name" onBlur={e => searchFieldChanged('name', e.target.value)} 
                                            onKeyPress={e => onKeyPress('name', e)}/>
                                        </th>
                                        <th className="px-3 py-3">
                                            <TextInput defaultValue={queryParams.email} className={"w-full "} placeholder="User Email" onBlur={e => searchFieldChanged('email', e.target.value)}/>
                                        </th>
                                        <th className="px-3 py-3"></th>
                                        <th className="px-3 py-3"></th>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={user.id}>
                                        ...
                                        <td className="px-3 py-2 text-nowrap">
                                            <Link href={route('user.edit', user.id)} className="font-medium text-blue-500 dark:text-blue-400 hover:underline mx-1">
                                                Edit
                                            </Link>
                                            <button
